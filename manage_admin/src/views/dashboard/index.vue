    ...
    <el-row class="home-part2" :gutter="0">
      <el-col :span="12">
        <div class="financing-sprinkled">
          <div class="title">
            <p class="title-value">融资金额及融资期限分布图示</p>
          </div>
          <div class="content" ref="">
            <!-- 融资 -->
            <div class="investment">
              <span class="title">融资金额比例</span>
...
<script>
  ...
  import NearSixMonth from '@/views/dashboard/near-six-month'
  import BScroll from 'better-scroll'
  import InvestmentPie from '@/views/dashboard/investment-pie'
  import FinancingPie from '@/views/dashboard/financing-pie'
  export default {
    components: {
      ColorLine,
      NearSixMonth,
